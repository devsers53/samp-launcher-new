...
set "LOG_FILE=%LOG_DIR%dynamic_build.log"
...
:: --- Configure CMake (dynamic build: runtime MinGW DLLs are kept) ---
echo Configuring CMake...
"%MINGW_CMAKE%" -S "%PROJECT_ROOT%." -B "%PROJECT_ROOT%build" -G Ninja -DCMAKE_MAKE_PROGRAM="%NINJA_PATH%" -DCMAKE_CXX_COMPILER="%MINGW_GXX%" -DCMAKE_BUILD_TYPE=Release -DSAMP_STATIC=OFF >> "%LOG_FILE%" 2>&1
